...
OAuth.prototype.getAuthorizeURL = function (redirect, state, scope) {
  var url = 'http://gz.feixin.10086.cn/Open/Authorize';
...
OAuth.prototype.getAccessToken = function (code, callback) {
  var url = 'http://117.136.240.2/op/open3/index.php/accessToken';
  var info = {
    appid: this.appid,
...
OAuth.prototype.refreshAccessToken = function (refreshToken, callback) {
  var url = 'http://117.136.240.2/op/open3/index.php/refreshToken';
  var info = {
    appid: this.appid,
...
OAuth.prototype._getUser = function (options, accessToken, callback) {
  var url = 'http://117.136.240.2/op/open3/index.php/userInfo';
  var info = {
